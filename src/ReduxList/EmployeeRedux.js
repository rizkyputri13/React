...
import { doGetEmp,doAddEmp,doIncSal,doDecSal } from '../Redux/Action/emp_action'
                                    ...
                                    (emp || []).map(emp => {
                                        return (
                                            <tr key={emp.empId}>
                                                ...
                                                <td>
                                                    <button onClick={() => dispatch(doIncSal({ id: emp.empId}))}> Tambah Gaji</button>
                                                    <button onClick={() => dispatch(doDecSal({ id: emp.empId}))}> Kurang Gaji</button>
                                                </td>
                                            </tr>
                                        )
                                    })
