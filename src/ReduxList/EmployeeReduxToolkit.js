...
import { doGetEmps, doAddEmps, incSal, decSal } from '../ReduxToolkit/EmpSlice'
                                    ...
                                    (emp || []).map(emp => {
                                        return (
                                            <tr key={emp.empId}>
                                                ...
                                                <td>
                                                    <button onClick={() => dispatch(incSal({ id: emp.empId}))}> Tambah Gaji</button>
                                                    <button onClick={() => dispatch(decSal({ id: emp.empId}))}> Kurang Gaji</button>
                                                </td>
                                            </tr>
                                        )
                                    })
